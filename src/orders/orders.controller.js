...
//validate for Post and Put requests
//validate body has Deliver to 
function bodyHasDeliverToProperty(req, res, next) {
    ...
    //pass the request body data to the next middleware using response.locals
    res.locals.reqBody = data;
    return next();
}

//validate body has mobile number
...
//validate body has dish quantity
